...
class PostController {
    static addPost(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let post = yield new Post_1.default(newPost).save();
                res.send(post);
            }
            catch (err) {
                next(err);
    ...
    static editPost(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updatedPost = yield Post_1.default.findOneAndUpdate({ _id: postId }, { content: content, updated_at: new Date() }, { new: true })
                    .populate('comments');
                if (updatedPost) {
